...
|---|---|---|
| Image pixel-content provider | Resolved for V1 | Keep the provider optional and disabled by default; ship an explicitly enabled OpenAI Responses adapter while preserving the implementation-neutral interface and offline no-provider behavior. |
